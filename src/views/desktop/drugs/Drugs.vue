...
import {drugsListService} from '@/api/drugs.js'
...
const addDose = async ()=>{
    ...
    //调用接口
    let result = await doseAddService(drugsModel.value);
...
const lists = [
  ...
  { name: 'Item 2', coverImg: 'https://example.com/image2.jpg' },
  { name: 'Item 3', coverImg: 'https://example.com/image3.jpg' },
  { name: 'Item 4', coverImg: 'https://example.com/image4.jpg' },
  { name: 'Item 5', coverImg: 'https://example.com/image5.jpg' },
  { name: 'Item 6', coverImg: 'https://example.com/image6.jpg' },
  { name: 'Item 7', coverImg: 'https://example.com/image7.jpg' },
  { name: 'Item 8', coverImg: 'https://example.com/image8.jpg' },
  { name: 'Item 9', coverImg: 'https://example.com/image9.jpg' },
  { name: 'Item 10', coverImg: 'https://example.com/image10.jpg' },
  { name: 'Item 1', coverImg: 'https://example.com/image1.jpg' },
  { name: 'Item 2', coverImg: 'https://example.com/image2.jpg' },
  { name: 'Item 3', coverImg: 'https://example.com/image3.jpg' },
  { name: 'Item 4', coverImg: 'https://example.com/image4.jpg' },
  ...
  <el-form inline>
    ...
    <el-drawer v-model="visibleDrawer" title="添加药物" direction="rtl" size="50%">
          ...
          <el-form :model="drugsModel" label-width="100px" >
                ...
                <el-form-item label="药物描述">
                    <div class="editor">
                        <quill-editor theme="snow" v-model:content="drugsModel.content" contentType="html"></quill-editor>
                    </div>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="addDose()">确定</el-button>
    ...
    <el-space style="width: 100%" fill>
      <el-skeleton  style="display: flex; gap: 8px; flex-wrap: wrap;"  :loading="loading"  animated  :count="3">
        ...
        <template #default>
          <!-- 绑定数据 -->
          <el-card  v-for="item in paginatedLists"  :key="item.name"  :body-style="{ padding: '0px', marginBottom: '1px' }"
